...
create policy if not exists "Users can view own roles or admins view all"
...
create table if not exists public.arquivos (
  id uuid primary key default gen_random_uuid(),
  produto_id uuid not null references public.produtos(id) on delete cascade,
  categoria_arquivo text not null check (categoria_arquivo in ('firmware','documento','vídeo','video','documento','documento_pdf')),
...
create table if not exists public.solicitacoes_firmware (
  id uuid primary key default gen_random_uuid(),
  numero_serie text,
  produto_nome text,
  descricao text,
...
create index if not exists idx_produtos_partnumber on public.produtos(partnumber);
create index if not exists idx_numeros_serie_numero on public.numeros_serie(numero_serie);
...
create policy if not exists "Categorias are viewable by everyone"
  on public.categorias for select to anon, authenticated using (true);
create policy if not exists "Subcategorias are viewable by everyone"
  on public.subcategorias for select to anon, authenticated using (true);
create policy if not exists "Produtos are viewable by everyone"
  on public.produtos for select to anon, authenticated using (true);
create policy if not exists "Numeros de serie are viewable by everyone"
  on public.numeros_serie for select to anon, authenticated using (true);
create policy if not exists "Arquivos are viewable by everyone"
...
create policy if not exists "Only admins can insert categorias"
  on public.categorias for insert to authenticated with check (public.has_role(auth.uid(),'admin'));
create policy if not exists "Only admins can update categorias"
...
create policy if not exists "Only admins can delete categorias"
  on public.categorias for delete to authenticated using (public.has_role(auth.uid(),'admin'));

create policy if not exists "Only admins can insert subcategorias"
  on public.subcategorias for insert to authenticated with check (public.has_role(auth.uid(),'admin'));
create policy if not exists "Only admins can update subcategorias"
...
create policy if not exists "Only admins can delete subcategorias"
  on public.subcategorias for delete to authenticated using (public.has_role(auth.uid(),'admin'));

create policy if not exists "Only admins can insert produtos"
  on public.produtos for insert to authenticated with check (public.has_role(auth.uid(),'admin'));
create policy if not exists "Only admins can update produtos"
...
create policy if not exists "Only admins can delete produtos"
  on public.produtos for delete to authenticated using (public.has_role(auth.uid(),'admin'));

create policy if not exists "Only admins can insert numeros_serie"
  on public.numeros_serie for insert to authenticated with check (public.has_role(auth.uid(),'admin'));
create policy if not exists "Only admins can update numeros_serie"
...
create policy if not exists "Only admins can delete numeros_serie"
  on public.numeros_erie for delete to authenticated using (public.has_role(auth.uid(),'admin'));

create policy if not exists "Only admins can insert arquivos"
  on public.arquivos for insert to authenticated with check (public.has_role(auth.uid(),'admin'));
create policy if not exists "Only admins can update arquivos"
...
create policy if not exists "Only admins can delete arquivos"
  on public.arquivos for delete to authenticated using (public.has_role(auth.uid(),'admin'));

create policy if not exists "Only admins can insert banners"
  on public.banners for insert to authenticated with check (public.has_role(auth.uid(),'admin'));
create policy if not exists "Only admins can update banners"
...
create policy if not exists "Only admins can delete banners"
...
create policy if not exists "Admins can delete solicitacoes"
